...
def result(expression,n,x,t,gt):
    ...
    win2.iconbitmap(r'C:\Users\ssaifuddin\Documents\Tri\tv.ico')
    e2=expression
...
def win1(gui):
    ...
    root.geometry("420x280+400+129")
    root.iconbitmap(r'C:\Users\ssaifuddin\Documents\Tri\tv.ico')
    equation=StringVar()
    expression_field =Entry(root, textvariable=equation,width=33,font=('Comic Sans MS',15))
...
#----------------------------------------------------------------------------------    
    button1 = Button(root, text=' 1 ',command=lambda: press(1), height=2, width=8,fg="#000",bg="#b3d9ff",font=('bold')) 
...
#----------------------------------------------------------------------------------
    button4 = Button(root, text=' 4 ',command=lambda: press(4), height=2, width=8, fg="#000",bg="#cce6ff",font=('bold')) 
...
#----------------------------------------------------------------------------------
    button7 = Button(root, text=' 7 ',command=lambda: press(7), height=2, width=8 ,fg="#000",bg="#e6f2ff",font=('bold')) 
...
#----------------------------------------------------------------------------------
    buttonAdd = Button(root, text='  ADD  ',command=lambda: press('+'), height=2, width=17,fg="#000",bg="#66d9ff",font=('bold')) 
